const header = () => {
  ...
  `;
    ...
    function toggleStickModalToTop() {
        if (
            modal.children.item('modal__content').offsetHeight >=
    ...
    header.addEventListener('click', (e) => {
        ...
        if (
            ...
            target.closest('.header__overlay')
        ) {
            headerToggleActive();
        }
        ...
        if (
            ...
            e.preventDefault();
            const headerLinkAttribute = target
                .closest('.header__link')
  ...
  <h3 class="modal__title--green">
    <svg>
      <use xlink:href="images/icons/sprite.svg#android_app"></use>
    </svg>
